...
public class RegistryRemotoImpl extends UnicastRemoteObject implements
	...
	final int tagSize = 100;
	// Tabella: la prima colonna contiene i nomi, la seconda i riferimenti remoti, la terza array di stringhe
	Object[][] table = new Object[tableSize][2];
	String[][] tag = new String[tableSize][tagSize];
